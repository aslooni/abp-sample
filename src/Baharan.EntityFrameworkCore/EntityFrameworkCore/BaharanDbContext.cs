...
using Account.EntityFrameworkCore;
...
public class BaharanDbContext :
    AbpDbContext<BaharanDbContext>,
    IIdentityDbContext,
    ITenantManagementDbContext
{
    ...
    public BaharanDbContext(DbContextOptions<BaharanDbContext> options)
        : base(options)
    {
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        builder.Entity<Personnel>(b =>
        {
            ...
            //b.Property(x => x.NationalCode).IsRequired().HasMaxLength(10);
            b.Property(x => x.UserId).IsRequired();
        });
        builder.Entity<Experience>(b =>
        {
            b.Property(x => x.StartDate).IsRequired();
            b.Property(x => x.PersonnelId).IsRequired();
        });
